...
void LvePipeline::CreateGraphicsPipeline(const std::string&        vertFilepath,
    ...
    if (vkCreateGraphicsPipelines(m_lveDevice.device(), VK_NULL_HANDLE, 1, &pipelineInfo, nullptr,
...
void LvePipeline::DefaultPipelineConfigInfo(PipelineConfigInfo& configInfo, uint32_t width,
                                            uint32_t height) {
